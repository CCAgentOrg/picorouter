...
.url = url or        # Use libsql client if available, else fall back to SQLite
        try:
...
COST_PER_MILLION = {
    ...
    "kilo": 0, "groq": 0.18, "openrouter": 0,
    "openai": 0.60, "anthropic": 0.80, "google": 0.00,
    "mistral": 0.40, "cohere": 0.30, "ai21": 0.40,
    "together": 0.60, "deepinfra": 0.44, "fireworks": 0.60,
    "replicate": 0.50, "azure": 1.00, "default": 0.50
}
